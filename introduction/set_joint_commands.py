...
class MyAgent(SparkAgent):
    def think(self, perception):
        ...
        # YOUR CODE HERE
        #print "Test stiffness 1: " + str(action.stiffness)
        #print "Test speed 1: " + str(action.speed)
        action.stiffness['LShoulderPitch'] = 0
        action.speed['HeadYaw'] = 0.1
        #print "Test stiffness 2: " + str(action.stiffness)
        #print "Test speed 2: " + str(action.speed)
        return action
